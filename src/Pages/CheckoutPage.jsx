...
const CheckoutPage = () => {
    const { cartItems, total, clearCart } = useCart(); // ✅ clearCart
                    ...
                    {paymentMode === "Online" && (
                        <div className="bg-yellow-100 border border-yellow-300 p-4 rounded text-sm text-black">
                            ...
                            <ul className="list-disc ml-6 mt-2">
                                <li>
                                    <a href="https://wa.me/916353616391" target="_blank" rel="noopener noreferrer" className="text-green-600 underline">
                                        WhatsApp
                                    </a>
                                </li>
                                <li>
